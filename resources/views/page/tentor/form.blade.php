                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="inputEnterYourName"
                                ...
                                value="{{ !empty($tentor) ? $tentor->user->name : '' }}">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="inputAddress4" class="col-sm-3 col-form-label">Alamat</label>
                        <div class="col-sm-9">
                            <textarea class="form-control" id="inputAddress4" rows="3" placeholder="Alamat" name="address">{{ !empty($tentor) ? $tentor->user->address : '' }}</textarea>
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="inputPhoneNo2" placeholder="No Telepon"
                                name="phone" value="{{ !empty($tentor) ? $tentor->user->phone : '' }}">
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <select class="form-select" id="pendidikan" name="pendidikan">
                                ...
                                @foreach ($pendidikan as $p)
                                    @if (!empty($tentor))
                                        <option value="{{ $p->id }}"
                                            {{ $p->id == $tentor->pendidikan_id ? ' selected ' : '' }}>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="inputUsernameAddress2" placeholder="Username"
                                name="username" value="{{ !empty($tentor) ? $tentor->user->username : '' }}">
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="email" class="form-control" id="inputEmailAddress2" placeholder="Email"
                                name="email" value="{{ !empty($tentor) ? $tentor->user->email : '' }}">
                        </div>
                    </div>
                    <div class="row mb-3">
